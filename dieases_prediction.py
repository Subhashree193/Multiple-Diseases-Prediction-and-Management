...
# TESTING DATA
tr=pd.read_csv("C:/Users/subha/Downloads/data analysis/Testing.csv")
...
# TRAINING DATA
df=pd.read_csv("C:/Users/subha/Downloads/data analysis/Training.csv")
...
def message():
    if (Symptom1.get() == "CHOOSE WHAT YOU FEELS" and  Symptom2.get() == "None" and Symptom3.get() == "None" and Symptom4.get() == "None" and Symptom5.get() == "None"):
